...
| JDK | `17` |
| Coordinates | `io.github.easy4j:webflux-swagger2-spring-boot-starter:1.0.0-SNAPSHOT` |
...
| `UiConfiguration` bean | ✅ Stable | Auto-registered via Swagger2WebFluxAutoConfiguration |
