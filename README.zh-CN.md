...
| JDK | `17` |
| 坐标 | `io.github.easy4j:webflux-swagger2-spring-boot-starter:1.0.0-SNAPSHOT` |
...
| `UiConfiguration` Bean | ✅ 稳定 | 通过 Swagger2WebFluxAutoConfiguration 自动注册 |
...
|---|---:|---|
| JDK | `17` | `pom.xml` |
| Spring Boot | `2.2.5.RELEASE` | `pom.xml` parent |
